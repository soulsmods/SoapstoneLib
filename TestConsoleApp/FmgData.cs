...
".Replace("\r\n", "\n"));
        ...
        private static readonly Dictionary<string, string> languageEnums = new()
        {
            ...
            ["deude"] = "German", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["enggb"] = "BritishEnglish", // [Bloodborne]
            ["engus"] = "English", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["finfi"] = "Finnish", // [Bloodborne]
            ["frafr"] = "French", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["itait"] = "Italian", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["jpnjp"] = "Japanese", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["korkr"] = "Korean", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["nldnl"] = "Dutch", // [Bloodborne]
            ["norno"] = "Norwegian", // [Bloodborne]
            ["polpl"] = "Polish", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["porbr"] = "BrazilPortuguese", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["porpt"] = "PortugalPortuguese", // [Bloodborne]
            ["rusru"] = "Russian", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["spaar"] = "Spanish", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["spaes"] = "SpainSpanish", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["swese"] = "Swedish", // [Bloodborne]
            ["turtr"] = "Turkish", // [Bloodborne]
            ["zhocn"] = "SimplifiedChinese", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["zhotw"] = "TraditionalChinese", // [Bloodborne, DarkSouls3, Sekiro, EldenRing, ArmoredCore6]
            ["thath"] = "Thai", // [Sekiro, EldenRing, ArmoredCore6]
            ["araae"] = "Arabic", // [EldenRing, ArmoredCore6]
        };
