        ...
        private static Dictionary<FromSoftGame, FmgGameInfo> MakeFmgGames() => new()
        {
            ...
            [FromSoftGame.ArmoredCore6] = new FmgGameInfo
            {
                ByType = new()
                {
                    ...
                    [FmgType.MissionInfo] = new FmgKeyInfo(FromSoftGame.ArmoredCore6, FmgCategory.Menu, FmgType.MissionInfo, FmgType.MissionInfo, "ミッション概要", 61),
                ...
                ByFmgName = new()
                {
                    ...
                    ["ミッション概要"] = new List<FmgType> { FmgType.MissionInfo },
                ...
                ByBinderID = new()
                {
                    ...
                    [61] = new List<FmgType> { FmgType.MissionInfo },
